...
import { Dialog, TextField, Typography, Button, Alert, AlertTitle } from '@mui/material'
            ...
            {trigger ?
                <div style={{ boxSizing: 'border-box', display: "flex", height: '500px', overFlow: 'hidden' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', width: '63%', padding: '2rem 1.5rem' }}>
                        <TextField variant='standard' label='Enter Username' InputLabelProps={{ style: { fontSize: "15px", fontFamily: "emoji" } }} value={login.logine} name='logine' onChange={(e) => loginChangeHandler(e)} />
                        <TextField variant='standard' label='Enter Password' InputLabelProps={{ style: { fontSize: "15px", fontFamily: "emoji" } }} value={login.loginp} name="loginp" onChange={(e) => loginChangeHandler(e)} />
